...
@Component({
  selector: 'AchievementAutopool',
  templateUrl: './achievementautopool.component.html',
  styleUrls: ['./achievementautopool.component.css']
})
export class AchievementautopoolComponent implements OnInit {
  rows: any[];
  ...
  ngOnInit(): void {
    if (!this.authService.isAuthenticated()) {
      ...
      this.achievementInput = document.getElementById('autopool-achievementInput') as HTMLInputElement;
      this.achievementDatetimeInput = document.getElementById('autopool-achievementDatetimeInput') as HTMLInputElement;
      this.useridInput = document.getElementById('autopool-useridInput') as HTMLInputElement;
      this.rewardDatetimeInput = document.getElementById('autopool-rewardDatetimeInput') as HTMLInputElement;
      this.remarksTextarea = document.getElementById('autopool-remarksTextarea') as HTMLTextAreaElement;
      this.submitButton = document.getElementById('autopool-submit-button') as HTMLButtonElement;
  ...
  showPopup(
    ...
    $('.ui.modal.autopool-achievements').modal({
      closable: false,
    }).modal('show');
  ...
  hidePopup() {
    ...
    $('.ui.modal.autopool-achievements').modal('hide');
  }
