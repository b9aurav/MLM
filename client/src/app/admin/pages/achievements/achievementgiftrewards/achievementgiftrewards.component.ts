...
@Component({
  selector: 'AchievementGiftRewards',
  templateUrl: './achievementgiftrewards.component.html',
  styleUrls: ['./achievementgiftrewards.component.css']
})
export class AchievementgiftrewardsComponent implements OnInit {
  rows: any[];
  ...
  ngOnInit(): void {
    if (!this.authService.isAuthenticated()) {
      ...
      this.achievementInput = document.getElementById('giftrewards-achievementInput') as HTMLInputElement;
      this.achievementDatetimeInput = document.getElementById('giftrewards-achievementDatetimeInput') as HTMLInputElement;
      this.useridInput = document.getElementById('giftrewards-useridInput') as HTMLInputElement;
      this.rewardDatetimeInput = document.getElementById('giftrewards-rewardDatetimeInput') as HTMLInputElement;
      this.remarksTextarea = document.getElementById('giftrewards-remarksTextarea') as HTMLTextAreaElement;
      this.submitButton = document.getElementById('giftrewards-submit-button') as HTMLButtonElement;
  ...
  showPopup(
    ...
    $('.ui.modal.giftrewards-achievements').modal({
      closable: false,
    }).modal('show');
  ...
  hidePopup() {
    ...
    $('.ui.modal.giftrewards-achievements').modal('hide');
  }
